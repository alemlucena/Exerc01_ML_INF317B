...
w = mu1-mu2;
x0 = 0.5*(mu1+mu2); % Classificador mínima distância -> x0 = 0.5*(mu1+mu2)-(1/(norm(mu1-mu2)^2))*(mu1-mu2)*log(p1/p2) -> termo log(1) = 0
...
contour(x1,x2,y1)
contour(x1,x2,y2)
tmp = plot(k,v,'--','Color',[0.9290 0.6940 0.1250],'LineWidth',1.5);
